...
import Developer from './components/pages/Portfoliodetail';
...
import Ramdan_reg_form from './event/Event/component/reg_form/Ramdan_reg_form ';
import Ramdan_reg_lucc_form from './event/Event/component/reg_form/Ramdan_reg_lucc_form';
import Events_profile_form_reg from './event/Event/component/reg_form/profile_form_reg';
import Ramdan_picnic_form_redirect from './event/Event/component/reg_form/Ramdan_picnic_form_redirect';
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Auth_eventRoute path="/event_registration_ramdan" component={Ramdan_reg_form} />
        <Auth_eventRoute path="/event_registration_ramdanlu" component={Ramdan_reg_lucc_form} />
         */}
        <Route path="/event_profile_form_reg" component={Events_profile_form_reg} />
        <Route path="/event_form _redirect" component={Ramdan_picnic_form_redirect} />
